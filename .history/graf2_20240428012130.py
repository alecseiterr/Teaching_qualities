...
def process_emotional_tone(data_path, new_data_path, file_path_to_save):
    ...
    # Merge main data with additional metrics
    ...
    # Get unique values in 'Эмоциональный_тон_LLM' column
    unique_emotional_tones = merged_data['Эмоциональный_тон_LLM'].unique()

    # Clean 'Эмоциональный_тон_LLM' column
    ...
    # Count frequency of occurrence of 1
