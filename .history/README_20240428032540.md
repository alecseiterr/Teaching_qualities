...
python main.py
```
После запуска выберите файл для анализа. Модель обработает данные, после чего вы сможете изучить графики и сформированные классы и характеристики лекции.
